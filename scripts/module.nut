...
function onPlayerArmourChange( player, lastArmour, newArmour ) {
  scripts_handle("onPlayerArmourChange", player, lastArmour, newArmour);
}

function onPlayerWeaponChange( player, oldWep, newWep ) {
  scripts_handle("onPlayerWeaponChange", player, oldWep, newWep);
}

function onPlayerAwayChange( player, status ) {
  scripts_handle("onPlayerAwayChange", player, player, status);
}

function onPlayerNameChange( player, oldName, newName ) {
  scripts_handle("onPlayerNameChange", player, oldName, newName);
}

function onPlayerActionChange( player, oldAction, newAction ) {
  scripts_handle("onPlayerActionChange", player, oldAction, newAction);
}
...
function onVehicleMove( vehicle, lastX, lastY, lastZ, newX, newY, newZ ) {
  scripts_handle("onVehicleMove", vehicle, lastX, lastY, lastZ, newX, newY, newZ);
}
...
function onPickupPickedUp( player, pickup ) {
  return scripts_handle("onPickupPickedUp", player, pickup);
}
...
function onCheckpointExited(player, checkpoint) {
  scripts_handle("onCheckpointExited", player, checkpoint);
}
